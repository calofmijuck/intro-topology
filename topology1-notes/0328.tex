...
\defn. We say that a topological space is a Fréchet-Urysohn space, if it satisfies the sequence lemma (\sref{Lemma 21.2}).
...
\defn. \textbf{Saturated Set} A subset \(C\) of \(X\) is \textbf{saturated} with respect to \(p\) if
\begin{center}
